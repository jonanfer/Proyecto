...
<div class="slider-wrapper theme-default">
	...
	<a href="<?php echo base_url(); ?>admin_user/add" class="button large success">Adicionar Usuario</a><br><br>
       ...
       <table class="table">
		   ...
		   <?php if ($row->rol_us != "Administrador" && $row->rol_us != "Empleado" && $row->rol_us != "Diseñador"): ?>
           <tr <?php if ($row->state_us == 'Inactivo') { echo 'class="danger"';} ?>>
              ...
              <td class="right">
                  <a href="<?php echo base_url(); ?>admin_user/lst/<?php echo $row->id_us; ?>" type="button" 
				  class="btn button small danger">
				  <i class="icon-search"></i></a>

				  <a href="<?php echo base_url(); ?>admin_user/upd/<?php echo $row->id_us; ?>" type="button" 
				  class="btn button small primary">
				  <i class="icon-pencil"></i></a>

				  <?php if ($row->state_us == "Activo"): ?>
				  <a href="<?php echo base_url(); ?>admin_user/updina/<?php echo $row->id_us; ?>" type="button" 
				  class="btn button small warning">
				  <i class="icon-key"></i></a>
				  <?php endif ?>

				  <?php if ($row->state_us == "Inactivo"): ?>
				  <a href="<?php echo base_url(); ?>admin_user/updhab/<?php echo $row->id_us; ?>" type="button" 
