...
<nav class="sidebar dark">
    <ul>
        ...
        <li class="active stick bg-yellow">
...
<div class="slider-wrapper theme-default">
	...
	<a href="<?php echo base_url(); ?>admin_disenador/add" class="button large success">Adicionar Diseñador</a><br><br>
       ...
       <table class="table">
           ...
           <tr <?php if ($row->state_us == 'Inactivo') { echo 'class="danger"';} ?>>
              ...
              <td class="right">
                  <a href="<?php echo base_url(); ?>admin_disenador/lst/<?php echo $row->id_us; ?>" type="button" 
				  class="btn button small danger">
				  <i class="icon-search"></i></a>

				  <a href="<?php echo base_url(); ?>admin_disenador/upd/<?php echo $row->id_us; ?>" type="button" 
				  class="btn button small primary">
				  <i class="icon-pencil"></i></a>

				  <?php if ($row->state_us == "Activo"): ?>
				  <a href="<?php echo base_url(); ?>admin_disenador/updina/<?php echo $row->id_us; ?>" type="button" 
				  class="btn button small warning">
				  <i class="icon-key"></i></a>
				  <?php endif ?>

				  <?php if ($row->state_us == "Inactivo"): ?>
				  <a href="<?php echo base_url(); ?>admin_disenador/updhab/<?php echo $row->id_us; ?>" type="button" 
