...
<head>
    ...
    <style>
        body{
            background: url(public/imgs/user2.jpg);
        }
        .content{
            width: 100%;
            max-width: 1000px;
        ...
        /* Media Query: Tamaño de Pantalla < 972px */
    ...
    /* Media Query: Tamaño de Pantalla < 490px */
...
<div class="slider-wrapper theme-default">
    ...
    <!---->
    <h1>Datos de Usuario - Empleado</h1>
       <table class="table">
           <thead>
           <tr>
           ...
           <?php if ($row->rol_us != "Administrador" && $row->rol_us != "Diseñador" && $row->rol_us != "Usuario"): ?>
